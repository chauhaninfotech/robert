                                ...
                                if (!empty($cat_arr)) {
                                    ...
                                    <div class="blog-list">
                                        ...
                                        if ($query->have_posts()) {
                                            ...
                                            <div class="blog-slider-prev"><a href="javascript:void(0);" title="<?php echo esc_html__('Previous', 'jobcareer'); ?>"><i class="icon-arrow-left9"></i></a></div>
                                            <div class="blog-slider-next"><a  href="javascript:void(0);" title="<?php echo esc_html__('Next', 'jobcareer'); ?>"><i class="icon-arrow-right9"></i></a></div>
