...
<img src="<?php echo site_url();?>/wp-content/uploads/2018/12/tooltip.png" class="active_q_icon">
			...
			<div class="col-md-12">
            	<div class="loger_img"><span style="display: inline-block;position: relative;"><i class="icon-edit3" data-toggle="modal" data-target="#avtar" style="position: absolute;right: 0px; bottom:40px; cursor: pointer;"></i>
		...
		?>
				...
				<div class="col-md-6">
					...
					<?php if($specialisms_header != "") { ?>
	                		...
	                		<?php } else { ?>
							<p style="color:#ffffff; font-size: 12px !important; margin-left:20px;">There is no record in Skills list</p>
							<?php } ?>
							</ul>
					</p></div>
				</div>
...
<span rel="<?php echo $mode; ?>" class="slider round"><strong style="margin: 5px 12px; display:inline-block; color:#fff;">Active</strong></span>
			...
			$cs_user_default_cover_style =  ($logerImgbg[0]) ? $logerImgbg[0] : '';
