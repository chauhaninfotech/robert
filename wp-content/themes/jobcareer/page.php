    ...
    <div class="main-section">
        ...
        if ( isset($jobcareer_xmlObject) && count($jobcareer_xmlObject) > 1 ) {
            ...
            foreach ( $jobcareer_xmlObject->column_container as $column_container ) {
                ...
                ?>
                <!-- Page Section -->
                <div <?php echo jobcareer_special_char($cs_section_css_id); ?> class="page-section<?php echo jobcareer_special_char($custom_bacground_option_class); ?> cs-page-sec-<?php echo absint($cs_section_rand_id) ?> <?php echo sanitize_html_class($parallax_class); ?>" <?php echo jobcareer_special_char($parallax_data_type); ?>  <?php //echo jobcareer_special_char($section_style_element);                               ?> >
                    <?php
                    if ( isset($cs_section_background_option) && $cs_section_background_option == 'section_background_video' ) {
                        $cs_section_video_url = $jobcareer_column_atts->cs_section_video_url;
                        if ( ! empty($cs_section_video_url) ) {
