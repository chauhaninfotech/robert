            ...
            <div class="col-md-12">
               ...
               <div id="London" class="tabcontent">
                  ...
                  <div class="col-md-12 col-lg-12 can-post">
                     ...
                     <div class="col-md-4 col-lg-4">
                        <div class="social">
                           <div class="linkedin"><a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i> Linkedin </a></div>
                        </div>
                        <div class="refer">
                           <div class="refer-link"><a href="#"><i class="fa fa-random" aria-hidden="true"></i> Refer this <br> Candidate </a></div>
                        </div>
                        <div class="message-btn">
                           <a href="#" class="btn btn-submit">Send a Message</a>
                        </div>
                     </div>
               ...
               <div id="Paris" class="tabcontent">
                  ...
                  <div class="col-md-12 col-lg-12 can-post job-list">
                     ...
                     <div class="col-md-4 col-lg-4">
						<div class="refer">
                           <div class="refer-link"><a href="#"><i class="fa fa-random" aria-hidden="true"></i> Refer a <br> Candidate </a></div>
                        </div>
                        <div class="social">
                           <div class="linkedin"><a href="#"><i class="fa fa-linkedin-square" aria-hidden="true"></i> Linkedin </a></div>
                        </div>
